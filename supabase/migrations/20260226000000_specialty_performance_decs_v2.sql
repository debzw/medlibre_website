-- ============================================================
-- Migration: Specialty Performance DeCS v2 (Table Join)
-- ============================================================

-- Update RPC: get_specialty_performance_diagnosis
...
BEGIN
    ...
    unnested_topics AS (
        ...
        -- Exclude the specialty term itself and all its synonyms (same decs_code).
        SELECT
        ...
        WHERE lower(trim(dt.clean_term)) != lower(trim(p_specialty))
